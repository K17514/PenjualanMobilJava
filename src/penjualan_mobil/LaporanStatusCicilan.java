...
public class LaporanStatusCicilan extends javax.swing.JFrame {
    ...
    public void tampildata() {
        try {
            ...
            String sql = "SELECT bc.kode_cicilan,k.kode_kredit,p.nama_pembeli,"
                    ...
                    + "bc.cicilanke,bc.jumlah_cicilan,bc.tanggal_cicilan,bc.sisa_cicilan,"
                    + "bc.sisaharga, "
                    + "CASE WHEN bc.sisaharga=0 THEN 'LUNAS' ELSE 'Belum Lunas' END AS status "
            ...
            model = new DefaultTableModel(new String[]{
                "Kode Cicilan", "Kode Kredit", "Nama Pembeli", "Merk dan Tipe Mobil",
                "Cicilanke-", "Cicilan Perbulan", "Tanggal Bayar", "Sisa Cicilan", "Sisa Harga", "Status Cicilan"
            }, 0);
            ...
            while (rs.next()) {
                model.addRow(new Object[]{
                    ...
                    rs.getString("mobil"),
                    rs.getDouble("cicilanke"),
                    rs.getDouble("jumlah_cicilan"),
                    rs.getDate("tanggal_cicilan"),
                    rs.getDouble("sisa_cicilan"),
                    rs.getDouble("sisaharga"),
                    rs.getString("status"),});
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Laporan Status Pembayaran Cicilan");
