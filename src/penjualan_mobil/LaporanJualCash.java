...
public class LaporanJualCash extends javax.swing.JFrame {
    ...
    public void tampildata() {
        try {
            ...
            String sql = "SELECT bc.kode_cash,p.nama_pembeli,"
                    + "CONCAT (m.merk,'',m.type) AS mobil"
                    + ",m.harga,bc.cash_tgl,bc.cash_bayar "
                    + "FROM beli_cash bc "
                    + "JOIN pembeli p ON bc.ktp=p.ktp "
                    + "JOIN mobil m ON bc.kode_mobil=m.kode_mobil ";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Laporan Penjualan Mobil Secara Cash");
        ...
        getContentPane().add(btnkembali, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 30, -1, -1));
